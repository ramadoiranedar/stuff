...
const { loadContacts, findContact, addContact, checkDuplicate, checkEmpty } = require('./utils/contacts')
...
app.get('/contact/add', (req, res) => { // MAKE SURE THIS CODE BEFURE MIDDLEWARE '/contact/:email'
...
app.post('/contact', 
    ...
    (req, res) => { // MAKE SURE THIS CODE BEFURE MIDDLEWARE '/contact/:email'
